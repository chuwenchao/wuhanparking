...
import com.mgear.wuhanparking.common.interceptor.PageInterceptor.Page;
...
public class FastJsonUtil {
    ...
    public static JSONObject getResultJson(String datas){
        JSONObject data = JSON.parseObject(datas);
        return data.getJSONObject("datas").getJSONObject("table").getJSONObject("row");
    }
    ...
    public static JSONArray getRetrunJSONArray(String datas){
        JSONObject data = JSON.parseObject(datas);
        return data.getJSONObject("datas").getJSONObject("table").getJSONArray("row");
    }
     ...
     * @return
     */
    public static String resultBack(List<Map> rs, String info, String tableName, Page page, Map<String,String> count) {
    	if(rs == null || rs.isEmpty()) {
    		return Consant.NO_RECORD; 
    	}
